...
Для запуска игры необходимо склонировать репозиторий со всеми файлами и запустить исполняемый файл /dist/dopustim_main. Если исполняемый файл не запускается на вашей ОС, то можно запустить программу с помощью скрипта, командой python3 dopustim_main.pyб расположенного в корне репозитория.
### Управление
